...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "FeedItem.publishedAt":
		if e.complexity.FeedItem.PublishedAt == nil {
			break
		}

		return e.complexity.FeedItem.PublishedAt(childComplexity), true
...
func (ec *executionContext) _FeedItem_publishedAt(ctx context.Context, field graphql.CollectedField, obj *model.FeedItem) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_FeedItem_publishedAt(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_FeedItem_publishedAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "FeedItem",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_Query_pullFeedItems(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "publishedAt":
				return ec.fieldContext_FeedItem_publishedAt(ctx, field)
			case "createdAt":
...
func (ec *executionContext) _FeedItem(ctx context.Context, sel ast.SelectionSet, obj *model.FeedItem) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "publishedAt":
			out.Values[i] = ec._FeedItem_publishedAt(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "createdAt":
