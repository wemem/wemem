...
exports.ZhihuHandler = void 0;
const content_handler_1 = require('../content-handler');
class ZhihuHandler extends content_handler_1.ContentHandler {
  constructor() {
    super();
    this.name = 'zhihu';
  }
  parseQuestion(element) {
    ...
    if (question) {
      ...
      if (votes) {
        newQuestion.innerHTML = `<h2>问题: ${votes} vote${votes === '1' ? '' : 's'}</h2>${question.innerHTML}`;
      }
    }
    return newQuestion;
  }
...
exports.ZhihuHandler = ZhihuHandler;
