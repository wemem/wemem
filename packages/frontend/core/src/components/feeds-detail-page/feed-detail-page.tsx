...
import { EditorChatPanel } from '../../desktop/pages/workspace/detail-page/tabs/chat';
import { EditorOutlinePanel } from '../../desktop/pages/workspace/detail-page/tabs/outline';
import {
  useIsActiveView,
  ViewSidebarTab,
  WorkbenchService,
} from '../../modules/workbench';
import { AffineErrorBoundary } from '../affine/affine-error-boundary';
import { GlobalPageHistoryModal } from '../affine/page-history-modal';
...
import { PageDetailEditor } from '../page-detail-editor';
